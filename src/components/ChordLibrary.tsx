...
export default function ChordLibrary() {
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-700">
      <div className="mb-4">
        <h2 className="text-lg font-semibold text-gray-100 mb-3">Chord Library</h2>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-gray-600 bg-gray-700 text-gray-100 placeholder-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="space-y-2">
        {filteredChords.map((chord) => (
          <div
            key={chord.id}
            className="p-3 border border-gray-600 bg-gray-700 rounded hover:bg-gray-600 transition-colors"
          >
            <div className="flex flex-col gap-2 mb-1">
              <div className="flex items-start justify-between">
                ...
                >
                  <div className="font-medium text-gray-100 truncate">{chord.name}</div>
      ...
      {showSaveDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50">
          <div className="bg-gray-800 border border-gray-600 rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold text-gray-100 mb-4">Save Chord</h3>
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-gray-600 text-gray-300 bg-gray-700 rounded hover:bg-gray-600 transition-colors"
                >
                  Cancel
                </button>
              </div>
